<html>
<head>
<title>Telkom Consumer Service Division - View Perumahan Tanah Sareal</title>
...
function peta_awal(){
    var bogor = new google.maps.LatLng(-6.558885,106.786766);
    var petaoption = {
        zoom: 14,
        center: bogor,
...
<div id="main_content">
        ...
        <div id="page_content">
                <div>
                    <ul class="menu">
                        <center><B>PETA TAMPILAN PERUMAHAN TANAH SAREAL</B></center>
                    </ul>
                </div>
          <div class="clear">
          	<br>
