<html>
<head>
<title>Telkom Consumer Service Division - View Perumahan Kecamatan Bogor Tengah</title>
...
function peta_awal(){
    var bogor = new google.maps.LatLng(-6.570823,106.787453);
    var petaoption = {
        zoom: 14,
        center: bogor,
...
<div id="main_content">
        ...
        <div id="page_content">
                <div>
                    <ul class="menu">
                        <center><B>PETA TAMPILAN PERUMAHAN KECAMATAN BOGOR BAGIAN TENGAH</B></center>
                    </ul>
                </div>
          <div class="clear">
          	<br>
