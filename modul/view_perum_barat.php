<html>
<head>
<title>Telkom Consumer Service Division - View Perumahan Kecamatan Bogor Barat</title>
...
function peta_awal(){
    var bogor = new google.maps.LatLng(-6.564,106.763);
    var petaoption = {
        zoom: 14,
        center: bogor,
...
<div id="main_content">
        ...
        <div id="page_content">
                <div>
                    <ul class="menu">
                        <center><B>PETA TAMPILAN PERUMAHAN KECAMATAN BOGOR BAGIAN BARAT</B></center>
                    </ul>
                </div>
          <div class="clear">
          	<br>
