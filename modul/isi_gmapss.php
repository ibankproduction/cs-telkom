...
$src = new mysrc($server, $user, $pw, $db, "sto_bogor");
?>
...
<div id="hehe" style="position: relative; left: 300; top: 650px">Copyright &copy; 2014 by Muhamad Iqbal Nasution, Google Technology, and DrasticData NL</div>
</div>
